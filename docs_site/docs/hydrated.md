...
:::tip
In a real application, you would use a persistent storage like `shared_preferences` or `hive`. See the [Advanced Patterns](example_advanced/) folder for a storage implementation using `path_provider`.
:::
