...
const config = {
  title: 'neat_state',
  tagline: 'Simple, powerful, and robust state management for Flutter',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} sla-000. Built with Docusaurus.`,
      },
      prism: {
